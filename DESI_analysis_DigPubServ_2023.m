...
dataset=readtable('DESI_Y7.csv', ReadVariableNames=true, VariableNamingRule='preserve');
...
%  in DPS
fid = fopen('output_DPS_2023.txt','w'); %open text file to put results
for i=29:33
...
writematrix(r_DD,'corr_DPS_2.xls');
...
%--------------------------------------------
% PCA_3:   Replicating the Classical analysis with all indicators in
...
%-----------------------------------------------
% PCA_4: Replicating the Classical analysis with all indicators except 4a5
